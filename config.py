...
DEBUG = os.environ.get('DEBUG', False)# Data settings
# Ajouter une variable DATA_FILE pour stocker le chemin vers le fichier Excel.
DATA_FILE = os.path.join(os.path.abspath(os.path.dirname(__file__)), 'resultats.xlsx')
...
MAX_SLEEP = os.environ.get('MAX_SLEEP', 5)# Scraper settings
API_KEY = os.environ.get('API_KEY', 'your_api_key_here')# Database settings
